...
g++ -std=c++0x -fPIC -fexceptions -fnon-call-exceptions -fno-pie -fno-stack-protector -Wno-pointer-arith -Wno-attributes -Winvalid-pch  -g -D_DEBUG  -DMEMDLEAK  -I../../../app/thirdparty/appseed -I. -I.. -I../.. -I../ca2 -I../../platform/freebsd -I../../platform/freebsd/include -I../../.. -I../../../app/appseed -I../../../app/appseed/ca -I../../../app/appseed/ca2 -I../../../app/thirdparty/include  -c /ca2/app-core/appseed/netnode_dynamic_source_script/ds_script.cpp -o "%CA2_ROOT%time/intermediate/%PLATFORM%/netnode_dynamic_source_script%ITEM_NAME%/%ITEM_TITLE%.o"
